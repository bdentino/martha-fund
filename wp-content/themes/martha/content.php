...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( has_post_thumbnail() && ( get_theme_mod( 'index_feat_image' ) != 1 ) ) : ?>
		<div class="entry-thumb">
			<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_post_thumbnail('martha-large-thumb'); ?></a>
		</div>
	<?php endif; ?>
	...
	<div class="entry-post">
		...
		<?php
			wp_link_pages( array(
				'before' => '<div class="page-links">' . __( 'Pages:', 'martha' ),
				'after'  => '</div>',
			) );
		?>
	</div><!-- .entry-post -->
