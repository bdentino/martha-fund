...
class Martha_Fund_Facts extends WP_Widget {

// constructor
    function martha_fund_facts() {
		$widget_ops = array('classname' => 'martha_fund_facts_widget', 'description' => __( 'Show your visitors some facts about the fund.', 'martha') );
        parent::__construct(false, $name = __('Martha FP: Fund Facts', 'martha'), $widget_ops);
		$this->alt_option_name = 'martha_fund_facts_widget';
    }
	...
	?>
	<p><?php _e('You can find a list of the available icons ', 'martha'); ?><a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_blank"><?php _e('here.', 'martha'); ?></a>&nbsp;<?php _e('Usage example: <strong>fa-android</strong>', 'martha'); ?></p>
	<p>
	<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'martha'); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
	</p>

	<!-- fact one -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_one'); ?>"><?php _e('First fact name', 'martha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_one_max'); ?>"><?php _e('First fact value', 'martha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_one_icon'); ?>"><?php _e('First fact icon', 'martha'); ?></label>
	...
	<!-- fact two -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_two'); ?>"><?php _e('Second fact name', 'martha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_two_max'); ?>"><?php _e('Second fact value', 'martha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_two_icon'); ?>"><?php _e('Second fact icon', 'martha'); ?></label>
	...
	<!-- fact three -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_three'); ?>"><?php _e('Third fact name', 'martha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_three_max'); ?>"><?php _e('Third fact value', 'martha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_three_icon'); ?>"><?php _e('Third fact icon', 'martha'); ?></label>
	...
	<!-- fact four -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_four'); ?>"><?php _e('Fourth fact name', 'martha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_four_max'); ?>"><?php _e('Fourth fact value', 'martha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_four_icon'); ?>"><?php _e('Fourth fact icon', 'martha'); ?></label>
	...
	function update($new_instance, $old_instance) {
		...
		if ( isset($alloptions['martha_fund_facts']) )
			delete_option('martha_fund_facts');
	...
	function widget($args, $instance) {
		$cache = array();
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'martha_fund_facts', 'widget' );
		}
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'martha_fund_facts', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	}
