...
get_header(); ?>
  ...
  <main id="main" class="site-main" role="main">
    ...
    <?php
    $martha_race_flyer_pdf = 'race day flyer 2026.png';
        ...
        <ul id="categories" class="clr">
          ...
          <li>
            <div data-target="#holy-family-institute">
              <img width="400" height="400" src="https://cldup.com/CTHCRNqtUr.png" class="attachment-thumbnail wp-post-image" alt="Holy-Family-Institute">
              <div class="overlay" data-target="#holy-family-institute"></div>
              <div class="overlay-hover" data-target="#holy-family-institute"></div>
              <h2 data-target="#holy-family-institute">Holy Family Institute</h2>
            </div>
          </li>

          <li>
            <div data-target="#bird-park">
              <img width="400" height="400" src="https://cldup.com/CTHCRNqtUr.png" class="attachment-thumbnail wp-post-image" alt="Bird-Park">
              <div class="overlay" data-target="#bird-park"></div>
              <div class="overlay-hover" data-target="#bird-park"></div>
              <h2 data-target="#bird-park">Bird Park</h2>
            </div>
          </li>

          <li>
            <div data-target="#jefferson-elementary">
              <img width="400" height="400" src="https://cldup.com/CTHCRNqtUr.png" class="attachment-thumbnail wp-post-image" alt="Jefferson-Elementary">
              <div class="overlay" data-target="#jefferson-elementary"></div>
              <div class="overlay-hover" data-target="#jefferson-elementary"></div>
              <h2 data-target="#jefferson-elementary">Jefferson Elementary</h2>
            </div>
          </li>

          <li>
            <div data-target="#holy-rosary-elementary">
              <img width="400" height="400" src="https://cldup.com/CTHCRNqtUr.png" class="attachment-thumbnail wp-post-image" alt="Holy-Rosary-Elementary">
              <div class="overlay" data-target="#holy-rosary-elementary"></div>
              <div class="overlay-hover" data-target="#holy-rosary-elementary"></div>
              <h2 data-target="#holy-rosary-elementary">Holy Rosary Elementary</h2>
            </div>
          </li>

          <li>
            <div data-target="#edgeworth-elementary">
              <img width="400" height="400" src="https://cldup.com/CTHCRNqtUr.png" class="attachment-thumbnail wp-post-image" alt="Edgeworth-Elementary">
              <div class="overlay" data-target="#edgeworth-elementary"></div>
              <div class="overlay-hover" data-target="#edgeworth-elementary"></div>
              <h2 data-target="#edgeworth-elementary">Edgeworth Elementary</h2>
            </div>
          </li>
