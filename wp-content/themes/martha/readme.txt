...
Martha, Copyright 2015
Martha is licensed under GNU General Public License V2 or later. You can find a copy of it in the license.txt file.
...
c) Icons
The icon set used in Martha is FontAwesome.
...
Theme documentation is available on http://athemes.com/documentation/martha/
